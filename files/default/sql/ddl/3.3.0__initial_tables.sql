...
CREATE TABLE IF NOT EXISTS `feature_monitoring_config` (
    ...
    `transformation_function_dataset_version` INT(11),
...
CREATE TABLE IF NOT EXISTS `feature_monitoring_result` (
    ...
    `detection_stats_id` INT(11), -- null only if no data in detection window
...
-- end alert changes for feature monitoring